...
appNameSuffix = vendor + "_Spark_JSON_Parquet"
...
dfrankedId = dfbaseData.withColumn("row_num", sf.row_number().over(Window.partitionBy("id").orderBy(sf.asc("updatedAtDate")))) \
