...
dfsplitColDataLookup = dfbaseData.select(sf.col("id")
                                    ,sf.col("EventType_1").alias("EventType")
                                    ,sf.col("EventType_lastChangeDate").alias("EventType_lastChangeDate")
                                    ,sf.col("EventType_2").alias("EventType_1")
                                    ,sf.col("EventType_1_lastChangeDate").alias("EventType_1_lastChangeDate")
                                    ,sf.col("EventType_3").alias("EventType_2")
                                    ,sf.col("EventType_2_lastChangeDate").alias("EventType_2_lastChangeDate")
                                    ,sf.col("EventType_4").alias("EventType_3")
                                    ,sf.col("EventType_3_lastChangeDate").alias("EventType_3_lastChangeDate")
                                    ,sf.col("mobileIdentityCreated")
                                    ,sf.col("mobileOperatorName")
                                    ,sf.col("statusIndex")
                                    ,sf.col("year")
                                    ,sf.col("month")
                                    ,sf.col("day"))
