...
# dfbaseData = reduce(lambda dfbaseData, idx: dfbaseData.withColumnRenamed(list(dfbaseData.schema.names)[idx],
                                                 # list(dfbaseData.schema.names)[idx].replace("connection_","connections_")),
            # range(len(list(dfbaseData.schema.names))),
            # dfbaseData)
